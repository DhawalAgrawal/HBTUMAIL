...
<div id="account"><?php $a = mysql_query("SELECT * FROM  `mailmembers` WHERE  `rid` LIKE  '".$_SESSION['rid']."' AND  `yn` =1") ; $b = mysql_fetch_array($a); ?>
<div id="la">
<div id="pho">
<?php if($b['image']=='null'){?>
<img src="images/blank-profile-picture-973460_960_720.png" width="100%" height="200px;" />
<?php }else{?>
<?php $info=pathinfo($b['image']); 
if($info["extension"]=="JPG"||$info["extension"]=="JPEG"||$info["extension"]=="jpg"||$info["extension"]=="jpeg"||$info["extension"]=="PNG"||$info["extension"]=="png"){?>
<img src="<?=$b['image']?>" width="100%" height="200px;" />
<?php }}?> </div>
<div id="name1"><?=$b['name']?></div>
</div>

<div id="ra">
<ul>
<li><div class="d1"><strong>Email :</strong></div><div class="d2"><?=' '.$b['email']?></div><!--<div id="edit"><a href="">Edit Info</a></div>--> </li>
<?php if($b['f_s']=='student'){ ?>
<li><div class="d1"><strong>Roll Number :</strong></div><div class="d2"><?=' '.$b['rollNumber']?></div></li>
<li><div class="d1"><strong>Year :</strong></div><div class="d2"><?=' '.$b['year']?></div></li>
<li><div class="d1"><strong>Branch :</strong></div><div class="d2"><?=' '.$b['branch']?></div></li>
<?php }else{ ?><li><div class="d1"><strong>ID Number :</strong></div><div class="d2"><?=' '.$b['rollNumber']?></div></li>
<li><div class="d1"><strong>Department :</strong></div><div class="d2"><?=' '.$b['branch']?></div></li><?php } ?>
</ul>
</div>
<span class="doClr"></span>
</div>
